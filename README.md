...
1. Download and unzip the newest [release](https://github.com/BananaramaCS/TheOtherRoles/releases/latest)
...
![SteamFindDirectory](./Images/SteamFindDirectory.png)

3. Drag or extract the files from the zip into your game, at the `.exe` level.
4. Run the game (the first launch might take a while)

![MyInstall](./Images/Installation_Instructions.png)
...
[TheOtherRoles](https://github.com/Eisbison/TheOtherRoles) - Upstream of this fork by **Eisbison** and main work of the mod\
